...
export default {
  ...
  options: [
    ...
    },
    {
      ...
      required: false,
      type: ApplicationCommandOptionType.String,
      choices: [{ name: "Bancho", value: "BANCHO" }, { name: "Akatsuki", value: "AKATSUKI" }, { name: "Akatsuki Relax", value: "AKATSUKIRX" }, { name: "Akatsuki Atopilot", value: "AKATSUKIAP" }, { name: "Gatari", value: "GATARI" }]
    },
  ],
