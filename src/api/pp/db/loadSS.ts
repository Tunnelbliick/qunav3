...
export async function loadacc100(mapid: number, checksum: string, mode: string, modArray: Mod[]) {
...
export async function loadacc100WithoutBeatMapDownload(mapid: number, checksum: string, modArray: Mod[], mode: string) {
